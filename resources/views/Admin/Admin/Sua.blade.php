                        ...
                        <form action="Admin/Admin/Them" method="POST">
                            <input type="hidden" name="_token" value="{{csrf_token()}}" />
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" name="PhoneNumber" placeholder="Nhập PhoneNumber" id="PhoneNumber" value="{{$user->phonenumber}}" />
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control" name="Email" placeholder="Nhập Email" type="email" value="{{$user->email}}" />
                            </div>
                             <div class="form-group">
                                <label>Name</label>
                                <input class="form-control" name="Name" placeholder="Nhập Name" id="Name" value="{{$user->name}}"/>
                            </div>
